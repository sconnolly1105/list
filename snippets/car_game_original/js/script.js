...
$(function() {
    ...
    $('h1').html("Sean Connolly's Race Game");
    ...
    $('#go').click(function() {
        ...
        var raceTime1 = Math.floor(Math.random() * (max - min + 1)) + min;
        var raceTime2 = Math.floor(Math.random() * (max - min + 1)) + min;

        console.log('raceTime1: ' + raceTime1);
        console.log('raceTime2: ' + raceTime2);

        // var raceTime1 = Math.floor( (Math.random() * 100000) + 1 );
        // var raceTime2 = Math.floor( (Math.random() * 100000) + 1 );
        ...
        $('#car1').animate({
            ...
            $('#raceInfo1 span').text( 'Finished in ' + place + ' place and checked in at ' + raceTime1 + ' milliseconds!' );
        ...
        $('#car2').animate({
            ...
            // give some text feedback in the race info box
            $('#raceInfo2 span').text( 'Finished in ' + place + ' place and checked in at ' + raceTime2 + ' milliseconds!' );
