...
$(function () {
    ...
    const PLACES = ['zero', 'first', 'second', 'third', 'fourth', 'fifth', 'sixth', 'seventh', 'eigth', 'ninth', 'tenth', 'eleventh', 'twelfth', 'thirteenth', 'fourteenth', 'fifteenth', 'sixteenth', 'seventeenth', 'eighteenth', 'nineteenth', 'twentieth'];
    const FRAMES = 10;
    const MAX = 25000;
    const MIN = 15000;
    ...
    function animateHorse(thisHorseObj) {
        ...
        $(horseContainer).animate({
            left: [(horsePosition + (raceTrackWidth / FRAMES)), "linear"]       // move the horse width of the racetrack
        }, timeTaken, function () {
            let pos = $(horseContainer).position();
            let horsePosition = pos.left;       // starting position is 8
